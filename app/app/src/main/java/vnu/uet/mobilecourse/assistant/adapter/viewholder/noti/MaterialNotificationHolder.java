...
public class MaterialNotificationHolder extends NotificationHolder<NewMaterialNotification> {

    public MaterialNotificationHolder(@NonNull View view) {
        super(view);
    }
    ...
    @Override
    protected void onNavigate(NewMaterialNotification notification, NavController navController, Fragment owner) {
