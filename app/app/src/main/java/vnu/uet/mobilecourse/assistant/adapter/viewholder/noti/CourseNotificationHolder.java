...
public class CourseNotificationHolder extends NotificationHolder<CourseAttendantNotification> {

    public CourseNotificationHolder(@NonNull View view) {
        super(view);
    }

    @Override
    protected int getIconResId() {
        return R.drawable.img_bag_bell;
    }

    @Override
    protected void onNavigate(CourseAttendantNotification notification, NavController navController, Fragment owner) {
